...
public class CreateUsedSkillsTree {
...
//      outputOneText(uri, level);
  ...
  private static void outputOneText(String uri, int level) {
    ...
    System.out.println(StringUtils.repeat("  ", level) + labelMap.get(uri) + "      " + jvCount + "  -  " + cvCount);
  }
